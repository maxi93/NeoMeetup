...
Un esempio di dato del genere è riportato in figura %FIXME: add fig.
...
\end{itemize} 
I principali vantaggi che Nifi ci ha fornito sono la gestione facilitata della queue, la possibilità di parsing e la facile interfaccia con il Kafka Consumer. Inoltre Nifi garantisce %FIXME: aggiungi fault tolerance etc dopo aver fatto check.
